...
metadata:
  ...
  version: "1.0.0"
  origin: "Adaptado desde retail-espacios/.claude/skills/design-system"
---
...
```
assets/designs/slides/sistemas-maestros-pitch-example.html
```

### Command

```bash
/slides:create "10-slide investor pitch for sistemas-maestros"
```
