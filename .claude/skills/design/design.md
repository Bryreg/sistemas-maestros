...
metadata:
  ...
  version: "2.1.0"
  origin: "Adaptado desde retail-espacios/.claude/skills/design"
---
...
|------|-----------|---------|
| Brand identity, voice, assets | `brand` | Skill de sistemas-maestros |
| Tokens, specs, CSS vars | `design-system` | Skill de sistemas-maestros |
| shadcn/ui, Tailwind, code | `ui-styling` | Skill de sistemas-maestros |
